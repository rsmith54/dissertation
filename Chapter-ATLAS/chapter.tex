...
The CSCs are arranged into four planes on the wheels of the muon spectrometer, as seen in \Cref{fig:csc_photo}.
...
\footnotetext{In Run-1, ATLAS ran with a three-level trigger system.
The L1 was essentially as today.
The HLT consisted of two separate systems known as the L2 trigger and the Event Filter (EF).
This was changed to the simpler system used today during the shutdown between Run-1 and Run-2.
}
