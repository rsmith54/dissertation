...
A schematic of the detector can be seen in \Cref{fig:atlas_full}.
...
The tracks reconstructed from the inner detector hits are used to reconstruct the primary vertices, as noted in \Cref{ch:lhc}, and to determine the momemta of charged particles.
