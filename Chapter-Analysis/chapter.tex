...
For the \gammajets events, the control region kinematic selection is identical to that of the corresponding signal region.\todo{is scale var loosened?}
\begin{figure}
...
As discussed above, this leads a to tolerable increase in the systematic uncertainty from the extrapolation from the CR to the SR
