...
This analysis uses the jet smearing method.\todo{TODO}
...
\todo{CR plots}
\todo{validation region summary plot}
...
Using the $CL_{\mathrm{S}}$ prescription \todo{cite} and neglecting the possible (small) signal contamination in control regions, we derive the the observed and expected limits on the number of events from BSM phenomena in each signal region.
