...
This is a reflection of the ``bag model'' discussed in Ch.\ref{ch:sm}, where each proton is actually a bag of incoming quarks and gluons, which individually contribute to the total proton energy.
...
The Large Hadron Collider is the last accelerator in a chain of accelerators which together form the CERN accelerator complex, shown in \ref{fig:accelerator_complex}.
\begin{figure}
...
From Eq.\ref{eq:rigidity}, this implies the momentum (or energy) of the beam is entirely determined by the magnetic field.
...
A schematic is shown in Fig.\ref{fig:dipole_schematic} and a photograph is present in Fig.\ref{fig:dipole_photo}.
\begin{figure}
...
In Figure \ref{fig:lumi}, we display the integrated luminosity per day for 2015 and 2016.
% \footnotemark
