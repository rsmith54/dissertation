...
In principle, these need to have any particular physical motivation.
...
\todo{check if I need to say anything else about the compressed case}
...
\todo{signal distributions???}

We describe here the variables used in the search described in \ref{ATLAS-CONF-2016-078}.
These were reconstructed using the RJR algorithm as just described, using the RestFrames packages.\todo{cite}
