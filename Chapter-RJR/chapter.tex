...
\subfloat[Disquark decay tree]  {\includegraphics[width=.45\linewidth]{ATLAS-CONF-2016-078/fig_02a}}\Cref{subfig:disquark_decay_tree}
\subfloat[Digluino decay tree]  {\includegraphics[width=.45\linewidth]{ATLAS-CONF-2016-078/fig_02b}}\Cref{subfig:digluino_decay_tree} \\
...
The decay tree in \Cref{subfig:disquark_decay_tree} corresponds exactly to that expected from disquark production, and matches very closely with the principles of the razor approach.
