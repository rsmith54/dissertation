...
\end{equation}
The $\sigma_{\text{ID,MS}}$ in the denominator of Eq.\Cref{eq:muon_sig} are the uncertainties on the corresponding quantity from the numerator.
...
\end{aligned}
\end{equation}
In Eq.\Cref{eq:kt}, $k_{T,i}$ is the transverse momentum of $i$-th jet \textit{constituent} and $\Delta_{ij}$ is the angular distance \deltaR between the constituents.
...
Representative distributions of TST \Emiss{x}, \Emiss{y}, and  \met from early 2015 datataking are shown in \Cref{fig:tst_met_zmumu}.
