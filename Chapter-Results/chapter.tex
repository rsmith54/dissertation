...
The full set of $N-1$ plots in the signal regions for the other variables used in the analysis are shown in \Cref{app:n-1_plots}.
...
In \Cref{tab:BreakdownSysSRCompressed_RJR}, we show the statistical significance Z for each signal region.
