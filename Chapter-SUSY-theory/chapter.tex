...
The second term \Cref{list:yukawa_couplings}, containing $a_u,a_d,a_e$, has strong contraints from experiments ~\cite{Hisano:1995nq,Gabbiani:1996hi}.
...
Off each branch of the Feynmann diagram shown in \Cref{fig:signal_feynmann}, we have $R=-1$, and this can only decay to another sparticle and a SM particle.
\begin{figure}
