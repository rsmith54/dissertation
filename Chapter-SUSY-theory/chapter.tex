...
This is a very interesting decay channel\footnotemark, due to the high cross-sections of $\supe{g} \supe{g}$ and $\supe{q} \supe{q}$ decays, as can be seen in Fig.\ref{fig:susy_xsec} \cite{Borschensky:2014cia}.
\footnotetext{Prior to Run1, probably the most \textit{most} interesting SUSY decay channel.}
\begin{figure}
...
We can also have the squark decay in association with a $W^\pm$ or $Z^0$; in this thesis, we are interested in those cases where this vector boson goes hadronically.
...
This is the most well-motivated reason for supersymmetry.
...
In the MSSM and many other forms of supersymmetry, the gauge couplings unify at high energy, as can be seen in Fig.\ref{fig:susy_gauge_couplings}.
...
We will see how this is done in Ch.\ref{ch:rjigsaw}.