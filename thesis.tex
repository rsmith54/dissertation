...
\include{./Chapter1/Chapter1}%SM   theory
\include{./Chapter2/Chapter2}%SUSY theory
\include{./Chapter3/Chapter3}%LHC
\include{./Chapter4/Chapter4}%ATLAS detector
\include{./Chapter5/Chapter5}%Recursive Jigsaw Reconstruction
\include{./Chapter6/Chapter6}%Search for SUSY in events with 0L using RJR
