...
\include{./Introduction/chapter.tex}       %Introduction
\include{./Chapter-Analysis/chapter.tex   }%SM   theory                                
\include{./Chapter-LHC/chapter.tex        }%SUSY theory                                
\include{./Chapter-RJR/chapter.tex        }%LHC                                        
\include{./Chapter-Results/chapter.tex    }%ATLAS detector                             
\include{./Chapter-SM-theory/chapter.tex  }%Recursive Jigsaw Reconstruction            
\include{./Chapter-SUSY-theory/chapter.tex}%Search for SUSY in events with 0L using RJR
\include{./Conclusion/chapter.tex}         %Conclusion
